      ...
      <div className=" container">
          ...
          {carts.map((product, index) =>            
              <tr key={index}>
                <td>
                  ...
                  <h6 className="card-text"><small>price: </small>$ {product.price}</h6>
                </td>
                <td>
                ...
                <td>
                  <h5>
                  <span className="badge badge-secondary">$ {product.total}</span>
                  </h5>
                </td>
                <td>
        ...
        { carts.length ? 
          <div><h3>
            ...
            <span className="float-right badge badge-secondary">$ {total}</span>
          </h3><hr/></div>: ''
        }
